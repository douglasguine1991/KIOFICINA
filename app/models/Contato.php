...
$sql = "INSERT INTO tbl_douglas_contato(assuntoContato,nomeContato,emailContato,telContato,mensContato)VALUE(:assuntoContato,:nomeContato,:emailContato,:telContato,:mensContato)";
