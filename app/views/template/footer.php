    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h3 class="modal-title fs-5" id="exampleModalLabel">Faça o login abaixo:</h3>
            ...
            <form method="POST" action="http://localhost/kioficina/public/auth/login">
                ...
                <div class="form-floating mb-3">
                    ...
                    <input type="email" class="form-control" id="floatingInput" placeholder="name@example.com" required name="email" id="email">

                </div>
                <label>Senha:</label>
                <div class="form-floating">

                    <input type="password" class="form-control" id="floatingPassword" placeholder="Password" required name="senha" id="senha">

                </div>
                <br>
                <br>
                <select class="form-select" aria-label="Default select example" name="tipo_usuario" id="tipo_usuario" required>
