<form method="POST" action="http://localhost/kioficina/public/cliente/editar/<?php echo $servico['id_servico']; ?>" enctype="multipart/form-data">
...
<div class="container my-5">
    ...
    <div class="row">
        ...
        <?php
// Definir um valor padrão para evitar erros caso $servico não esteja definido
$fotogaleria = isset($servico['foto_galeria']) ? $servico['foto_galeria'] : null;
$fotoPath = "http://localhost/kioficina/public/uploads/" . $fotogaleria;
$fotoDefault = "http://localhost/kioficina/public/uploads/cliente/sem-foto-servico.png";

// Verificar se a imagem existe e se a variável não está vazia
if (!empty($fotogaleria) && file_exists($_SERVER['DOCUMENT_ROOT'] . "/kioficina/public/uploads/" . $fotogaleria)) {
    $imagePath = $fotoPath;
} else {
    $imagePath = $fotoDefault;
}
?>
        ...
        <div class="col-md-8">
            ...
            <div class="mb-3">
                <label for="descricao_servico" class="form-label">Descrição do Cliente:</label>
            ...
            <div class="row g-3">
                <div class="col-md-3">
                    <label for="preco_base_servico" class="form-label">!!!!</label>
                ...
                <div class="col-md-3">
                    <label for="tempo_estimado_servico" class="form-label">!!!!</label>
                ...
                <div class="col-md-3">
                    <label for="especialidade" class="form-label">!!!!</label>
